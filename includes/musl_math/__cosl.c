...
/*
 * Edoardo Manino: renamed to __k_cosl() to avoid a declaration
 * conflict with the vector function __cosl() in math.h
 */
long double __k_cosl(long double x, long double y)
{
