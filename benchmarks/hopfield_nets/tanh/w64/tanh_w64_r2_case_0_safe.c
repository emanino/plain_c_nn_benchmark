...
#include <hopfield_nets/tanh/w64/hop_tanh_w64_r2.h>
...
int main()
{
	...
	hop_tanh_w64_r2(&input_tensor,&output_tensor);
	
	__VERIFIER_assert(isgreaterequal(output_array[64], 0.0f)); /* Expected result: verification successful */
