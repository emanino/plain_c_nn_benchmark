...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.030230712382939437) && (tensor_output[0][1] >= -0.030230712382939437) && (tensor_output[0][2] <= 0.030230712382939437) && (tensor_output[0][2] >= -0.030230712382939437) && (tensor_output[0][0] >= 0.15997867658304782)));
