...
#include <hopfield_nets/softsign/w64/hop_softsign_w64_r3.h>
...
int main()
{
	...
	__VERIFIER_assert(isgreaterequal(output_array[128], 0.0f)); /* Expected result: verification successful */
