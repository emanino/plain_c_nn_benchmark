...
#include "../hopfield_nets/hop_tanh_w64_r4.h"
...
int main()
{
	...
	hop_tanh_w64_r4(&input_tensor,&output_tensor);
	
	__ESBMC_assert(isgreaterequal(output_array[254], 0.0f), ""); /* Expected result: verification successful */
