...
int main()
{
	...
	__VERIFIER_assume(tensor_dense_input[0][2] >= -0.39568809552103407f && tensor_dense_input[0][2] <= -0.2604710893208711f);
	__VERIFIER_assume(tensor_dense_input[0][3] >= -0.1690353411176737f && tensor_dense_input[0][3] <= -0.03381833491751075f);
	__VERIFIER_assume(tensor_dense_input[0][4] >= 0.4323914968999185f && tensor_dense_input[0][4] <= 0.5676085031000815f);
	__VERIFIER_assume(tensor_dense_input[0][5] >= -0.06760850310008143f && tensor_dense_input[0][5] <= 0.06760850310008154f);
	__VERIFIER_assume(tensor_dense_input[0][6] >= 0.007338307612623801f && tensor_dense_input[0][6] <= 0.14255531381278677f);
	__VERIFIER_assume(tensor_dense_input[0][7] >= -0.5619595681985536f && tensor_dense_input[0][7] <= -0.42674256199839067f);
