...
int main()
{
	...
	__ESBMC_assume(tensor_dense_input[0][0] >= 0.2846299114097988f && tensor_dense_input[0][0] <= 0.42247686977674853f);
	__ESBMC_assume(tensor_dense_input[0][1] >= -0.42247686977674853f && tensor_dense_input[0][1] <= -0.2846299114097988f);
	__ESBMC_assume(tensor_dense_input[0][2] >= -0.06892347918347484f && tensor_dense_input[0][2] <= 0.06892347918347484f);
	__ESBMC_assume(tensor_dense_input[0][3] >= -0.06892347918347484f && tensor_dense_input[0][3] <= 0.06892347918347484f);
	__ESBMC_assume(tensor_dense_input[0][4] >= 0.14873240054018394f && tensor_dense_input[0][4] <= 0.28657935890713365f);
	__ESBMC_assume(tensor_dense_input[0][5] >= -0.06892347918347483f && tensor_dense_input[0][5] <= 0.06892347918347486f);
	__ESBMC_assume(tensor_dense_input[0][6] >= 0.6789735304610051f && tensor_dense_input[0][6] <= 0.8168204888279548f);
	__ESBMC_assume(tensor_dense_input[0][7] >= -0.5874396456582737f && tensor_dense_input[0][7] <= -0.44959268729132396f);
