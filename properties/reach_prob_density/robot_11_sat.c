...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.1715538135524651) && (tensor_output[0][1] >= -0.1715538135524651) && (tensor_output[0][2] <= 0.1715538135524651) && (tensor_output[0][2] >= -0.1715538135524651) && (tensor_output[0][0] >= 0.269040247178918)));
