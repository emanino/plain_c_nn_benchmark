...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.761536245031033) && (tensor_output[0][1] >= -0.761536245031033) && (tensor_output[0][2] <= 0.761536245031033) && (tensor_output[0][2] >= -0.761536245031033) && (tensor_output[0][0] >= 0.1545942732588128)));
