...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.69417093575195) && (tensor_output[0][1] >= -0.69417093575195) && (tensor_output[0][2] <= 0.69417093575195) && (tensor_output[0][2] >= -0.69417093575195) && (tensor_output[0][0] >= 0.29409921696577157)));
