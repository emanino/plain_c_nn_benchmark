...
int main()
{
	...
	__ESBMC_assume(tensor_input[0][2] >= -6.856186761127681f && tensor_input[0][2] <= 6.8640379382196155f);
	__ESBMC_assume(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f);
	__ESBMC_assume(tensor_input[0][4] >= -1.2120519616738326f && tensor_input[0][4] <= 5.195179481948719f);
	__ESBMC_assume(tensor_input[0][5] >= -6.8356139084846035f && tensor_input[0][5] <= 6.90211584478238f);
	__ESBMC_assume(tensor_input[0][6] >= -6.850710545768149f && tensor_input[0][6] <= 6.839205647570927f);
	__ESBMC_assume(tensor_input[0][7] >= -6.974735887608149f && tensor_input[0][7] <= 6.964618881495624f);
	__ESBMC_assume(tensor_input[0][8] >= -6.8559133523561f && tensor_input[0][8] <= 6.824128877175476f);
	__ESBMC_assume(tensor_input[0][9] >= -6.9197729478190615f && tensor_input[0][9] <= 6.917144390558026f);
	__ESBMC_assume(tensor_input[0][10] >= -6.8323039584820195f && tensor_input[0][10] <= 6.805704984308347f);
