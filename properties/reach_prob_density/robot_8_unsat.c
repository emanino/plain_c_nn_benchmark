...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.04889690792887813) && (tensor_output[0][1] >= -0.04889690792887813) && (tensor_output[0][2] <= 0.04889690792887813) && (tensor_output[0][2] >= -0.04889690792887813) && (tensor_output[0][0] >= 0.2430583183337539)));
