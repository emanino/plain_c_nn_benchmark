...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.6140383538111273) && (tensor_output[0][1] >= -0.6140383538111273) && (tensor_output[0][2] <= 0.6140383538111273) && (tensor_output[0][2] >= -0.6140383538111273) && (tensor_output[0][0] >= 0.2072691835138419)));
