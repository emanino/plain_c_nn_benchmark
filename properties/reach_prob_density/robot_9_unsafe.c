...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.22510209287602703) && (tensor_output[0][1] >= -0.22510209287602703) && (tensor_output[0][2] <= 0.22510209287602703) && (tensor_output[0][2] >= -0.22510209287602703) && (tensor_output[0][0] >= 0.1362501380036763)));
