...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.04106493029448468) && (tensor_output[0][1] >= -0.04106493029448468) && (tensor_output[0][2] <= 0.04106493029448468) && (tensor_output[0][2] >= -0.04106493029448468) && (tensor_output[0][0] >= 0.23104722700813274)));
