...
int main()
{
	...
	__ESBMC_assume(tensor_input[0][2] >= -3.46780197151747f && tensor_input[0][2] <= 3.475653148609406f);
	__ESBMC_assume(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f);
	__ESBMC_assume(tensor_input[0][4] >= -0.19923915975231457f && tensor_input[0][4] <= 5.195179481948719f);
	__ESBMC_assume(tensor_input[0][5] >= -3.4429060221509418f && tensor_input[0][5] <= 3.5094079584487177f);
	__ESBMC_assume(tensor_input[0][6] >= -3.4698108289613714f && tensor_input[0][6] <= 3.4583059307641495f);
	__ESBMC_assume(tensor_input[0][7] >= -3.532234127497857f && tensor_input[0][7] <= 3.5221171213853317f);
	__ESBMC_assume(tensor_input[0][8] >= -3.4774521370689127f && tensor_input[0][8] <= 3.44566766188829f);
	__ESBMC_assume(tensor_input[0][9] >= -3.5025694200458517f && tensor_input[0][9] <= 3.499940862784815f);
	__ESBMC_assume(tensor_input[0][10] >= -3.464223400405062f && tensor_input[0][10] <= 3.4376244262313893f);
