...
int main()
{
	...
	__ESBMC_assume(tensor_input[0][2] >= -3.0212351089328653f && tensor_input[0][2] <= 3.029086286024801f);
	__ESBMC_assume(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f);
	__ESBMC_assume(tensor_input[0][4] >= 1.6532894732949566f && tensor_input[0][4] <= 5.195179481948719f);
	__ESBMC_assume(tensor_input[0][5] >= -2.995769403809446f && tensor_input[0][5] <= 3.062271340107222f);
	__ESBMC_assume(tensor_input[0][6] >= -3.0242304498152164f && tensor_input[0][6] <= 3.0127255516179945f);
	__ESBMC_assume(tensor_input[0][7] >= -3.078535003606063f && tensor_input[0][7] <= 3.068417997493538f);
	__ESBMC_assume(tensor_input[0][8] >= -3.0321931364085635f && tensor_input[0][8] <= 3.000408661227941f);
	__ESBMC_assume(tensor_input[0][9] >= -3.0522044370339096f && tensor_input[0][9] <= 3.0495758797728727f);
	__ESBMC_assume(tensor_input[0][10] >= -3.020332502191682f && tensor_input[0][10] <= 2.993733528018009f);
