...
int main()
{
	...
	__VERIFIER_assume(tensor_input[0][2] >= -5.419814470131783f && tensor_input[0][2] <= 5.4276656472237175f);
	__VERIFIER_assume(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f);
	__VERIFIER_assume(tensor_input[0][4] >= 0.29468381050771036f && tensor_input[0][4] <= 5.195179481948719f);
	__VERIFIER_assume(tensor_input[0][5] >= -5.39740901088396f && tensor_input[0][5] <= 5.463910947181736f);
	__VERIFIER_assume(tensor_input[0][6] >= -5.41751125661192f && tensor_input[0][6] <= 5.4060063584146985f);
	__VERIFIER_assume(tensor_input[0][7] >= -5.51542283819033f && tensor_input[0][7] <= 5.505305832077805f);
	__VERIFIER_assume(tensor_input[0][8] >= -5.423747769886618f && tensor_input[0][8] <= 5.391963294705994f);
	__VERIFIER_assume(tensor_input[0][9] >= -5.471184087711614f && tensor_input[0][9] <= 5.468555530450578f);
	__VERIFIER_assume(tensor_input[0][10] >= -5.404538846828255f && tensor_input[0][10] <= 5.377939872654582f);
