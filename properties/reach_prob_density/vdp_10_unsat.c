...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.6611040870813922) && (tensor_output[0][1] >= -0.6611040870813922) && (tensor_output[0][2] <= 0.6611040870813922) && (tensor_output[0][2] >= -0.6611040870813922) && (tensor_output[0][0] >= 0.28075401898993385)));
