...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.03281770965307063) && (tensor_output[0][1] >= -0.03281770965307063) && (tensor_output[0][2] <= 0.03281770965307063) && (tensor_output[0][2] >= -0.03281770965307063) && (tensor_output[0][0] >= 0.17121804550093517)));
