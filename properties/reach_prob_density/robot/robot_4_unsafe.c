...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.19890077332036324) && (tensor_output[0][1] >= -0.19890077332036324) && (tensor_output[0][2] <= 0.19890077332036324) && (tensor_output[0][2] >= -0.19890077332036324) && (tensor_output[0][0] >= 0.19456631910792194)));
