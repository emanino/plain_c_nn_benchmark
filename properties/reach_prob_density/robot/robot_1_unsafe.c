...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.24500044796545045) && (tensor_output[0][1] >= -0.24500044796545045) && (tensor_output[0][2] <= 0.24500044796545045) && (tensor_output[0][2] >= -0.24500044796545045) && (tensor_output[0][0] >= 0.22185339654566427)));
