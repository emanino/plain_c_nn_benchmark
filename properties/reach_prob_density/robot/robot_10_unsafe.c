...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.16943059486986362) && (tensor_output[0][1] >= -0.16943059486986362) && (tensor_output[0][2] <= 0.16943059486986362) && (tensor_output[0][2] >= -0.16943059486986362) && (tensor_output[0][0] >= 0.16744696798540254)));
