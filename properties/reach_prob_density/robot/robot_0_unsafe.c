...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.14063126799167602) && (tensor_output[0][1] >= -0.14063126799167602) && (tensor_output[0][2] <= 0.14063126799167602) && (tensor_output[0][2] >= -0.14063126799167602) && (tensor_output[0][0] >= 0.06360789758578266)));
