...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.2638005964406899) && (tensor_output[0][1] >= -0.2638005964406899) && (tensor_output[0][2] <= 0.2638005964406899) && (tensor_output[0][2] >= -0.2638005964406899) && (tensor_output[0][0] >= 0.1821035207086758)));
