...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.6589935021747955) && (tensor_output[0][1] >= -0.6589935021747955) && (tensor_output[0][2] <= 0.6589935021747955) && (tensor_output[0][2] >= -0.6589935021747955) && (tensor_output[0][0] >= 0.2033159137005948)));
