...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.22863150440118682) && (tensor_output[0][1] >= -0.22863150440118682) && (tensor_output[0][2] <= 0.22863150440118682) && (tensor_output[0][2] >= -0.22863150440118682) && (tensor_output[0][0] >= 0.23142619518576774)));
