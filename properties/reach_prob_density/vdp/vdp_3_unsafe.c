...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.4529933122375583) && (tensor_output[0][1] >= -0.4529933122375583) && (tensor_output[0][2] <= 0.4529933122375583) && (tensor_output[0][2] >= -0.4529933122375583) && (tensor_output[0][0] >= 0.16946199097343945)));
