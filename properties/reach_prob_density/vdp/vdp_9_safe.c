...
int main()
{
	...
	__VERIFIER_assert(!((tensor_output[0][1] <= 0.534015641720591) && (tensor_output[0][1] >= -0.534015641720591) && (tensor_output[0][2] <= 0.534015641720591) && (tensor_output[0][2] >= -0.534015641720591) && (tensor_output[0][0] >= 0.24618668166657065)));
