...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.053810551856458395) && (tensor_output[0][1] >= -0.053810551856458395) && (tensor_output[0][2] <= 0.053810551856458395) && (tensor_output[0][2] >= -0.053810551856458395) && (tensor_output[0][0] >= 0.12065253547601361)));
