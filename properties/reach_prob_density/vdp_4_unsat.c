...
int main()
{
	...
	__ESBMC_assert(!((tensor_output[0][1] <= 0.6034337034239154) && (tensor_output[0][1] >= -0.6034337034239154) && (tensor_output[0][2] <= 0.6034337034239154) && (tensor_output[0][2] >= -0.6034337034239154) && (tensor_output[0][0] >= 0.2821680445877145)));
